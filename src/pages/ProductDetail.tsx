...
export default function ProductDetail() {
  ...
  useEffect(() => {
    if (product?.id) {
      ...
      reviewsApi.getByProduct(product.id).then((data) => {
        setReviews(data);
                  ...
                  {user ? (
                    <div style={{ marginBottom: "2rem", padding: "1.5rem", background: "#1a1a1a", borderRadius: 6, border: "1px solid rgba(212,175,55,0.15)" }}>
                      ...
                      <input
                        ...
                        maxLength={100}
                        style={{ width: "100%", background: "#0d0d0d", border: "1px solid rgba(212,175,55,0.2)", borderRadius: 4, padding: "0.6rem 0.8rem", color: "var(--color-text)", fontFamily: "var(--font-sans)", fontSize: "0.85rem", marginBottom: "0.75rem", outline: "none", boxSizing: "border-box" }}
                      />
                      <textarea
                        ...
                        maxLength={2000}
                        rows={3}
                        style={{ width: "100%", background: "#0d0d0d", border: "1px solid rgba(212,175,55,0.2)", borderRadius: 4, padding: "0.6rem 0.8rem", color: "var(--color-text)", fontFamily: "var(--font-sans)", fontSize: "0.85rem", marginBottom: "0.75rem", outline: "none", resize: "vertical", boxSizing: "border-box" }}
                      />
                        ...
                        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: "0.75rem" }}>
                          <div>
                            <div style={{ display: "flex", alignItems: "center", gap: "0.5rem", marginBottom: "0.25rem" }}>
                              ...
                              {review.verified && (
                                <span style={{ fontFamily: "var(--font-display)", fontSize: "0.55rem", fontWeight: 600, letterSpacing: "0.08em", textTransform: "uppercase", color: "var(--color-success)", background: "rgba(46,204,113,0.1)", padding: "0.15rem 0.5rem", borderRadius: 3 }}>Verified Purchase</span>
                              )}
                            </div>
                            <div style={{ display: "flex" }}>
                              {[1, 2, 3, 4, 5].map((s) => (
